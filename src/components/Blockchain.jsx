...
const Blockchain = () => {
    ...
    return (<>
        <Box className={classes.container}>
            <Typography className={classes.heading}><RemoveIcon className={classes.icon} />&nbsp;Blockchain <Typography variant="span" style={{ color: "#4287f5", fontWeight: 600 }}>&nbsp;Blogs</Typography>&nbsp;<RemoveIcon className={classes.icon} /></Typography>
